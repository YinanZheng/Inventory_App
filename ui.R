          ...
          tabPanel(
            ...
            fluidRow(
              column(
                ...
                div(
                  class = "card",
                  style = "height: 330px; margin-bottom: 5px; padding: 5px; border: 1px solid #007BFF; border-radius: 8px; box-shadow: 0px 4px 6px rgba(0,0,0,0.1);",
              ...
              column(
                ...
                div(
                  ...
                  plotlyOutput("inventory_status_chart", height = "280px") # 使用 plotlyOutput
                )
              ),
              ...
              column(
                ...
                div(
                  ...
                  plotlyOutput("defect_status_chart", height = "280px") # 使用 plotlyOutput
                )
              )
            ),
