                     ...
                     div(
                       ...
                       tags$h4(
                         HTML(paste0(
                           ...
                           "  货架  ",
                           span(style = "display: inline; color: #007BFF; font-size: 18px;", textOutput("shelf_count")) # 动态显示数量
                         )),
                     ...
                     div(
                       ...
                       tags$h4(
                         HTML(paste0(
                           ...
                           "  发货箱  ",
                           span(style = "display: inline; color: #28A745; font-size: 18px;", textOutput("box_count")) # 动态显示数量
                         )),
